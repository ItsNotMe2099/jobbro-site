...
import {IGeoName, ISearchCountryResult} from '@/data/interfaces/ILocation'
import {ILocationCityListRequest} from '@/data/interfaces/ILocationCityListRequest'
import {AxiosRequestConfig} from 'axios/index'

export default class LocationRepository {

  static async fetchCountries(data: ILocationCountryListRequest, config?: AxiosRequestConfig): Promise<IPagination<ISearchCountryResult>> {
    const res = await request<IPagination<ISearchCountryResult>>({
