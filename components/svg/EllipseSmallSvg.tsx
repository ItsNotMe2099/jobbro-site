...
export default function EllipseSmallSvg(props: Props) {
  
  return (
    <svg className={props.className} width="125" height="349" viewBox="0 0 125 349" fill="none" xmlns="http://www.w3.org/2000/svg">
