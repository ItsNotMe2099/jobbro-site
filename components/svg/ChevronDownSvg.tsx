...
export default function ChevronDownSvg(props: Props) {
  return (
    <svg className={props.className} xmlns="http://www.w3.org/2000/svg" style={{rotate: (props.direction === 'left'&& '90deg') || (props.direction === 'right' && '-90deg') || '0'}} width="41" height="40" viewBox="0 0 41 40" fill="none">
