...
import styles from 'components/for_pages/FindJobs/VacanciesByLocation/VacanciesByLocationCard/index.module.scss'
...
export default function VacanciesByLocationCard(props: Props) {
